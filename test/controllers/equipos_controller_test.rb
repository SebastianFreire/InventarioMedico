...
class EquiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipo" do
    assert_difference("Equipo.count") do
      post equipos_url, params: { equipo: { adquisition: @equipo.adquisition, description: @equipo.description, location: @equipo.location, name: @equipo.name, serial: @equipo.serial, state: @equipo.state } }
    end
  ...
  test "should update equipo" do
    patch equipo_url(@equipo), params: { equipo: { adquisition: @equipo.adquisition, description: @equipo.description, location: @equipo.location, name: @equipo.name, serial: @equipo.serial, state: @equipo.state } }
