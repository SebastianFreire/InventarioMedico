...
class EquiposTest < ApplicationSystemTestCase
  ...
  test "should create equipo" do
    ...
    fill_in "Adquisition", with: @equipo.adquisition
    fill_in "Description", with: @equipo.description
    fill_in "Location", with: @equipo.location
    fill_in "Name", with: @equipo.name
    fill_in "Serial", with: @equipo.serial
    fill_in "State", with: @equipo.state
